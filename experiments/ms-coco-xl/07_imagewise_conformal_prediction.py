...
if __name__ == "__main__":
    ...
    non_conformity_curve = torch.from_numpy(non_conformity_curve).unsqueeze(-1).unsqueeze(-1).unsqueeze(-1)

    # Put back in image shape
    non_conformity_curves = non_conformity_curve.expand(101, 1, *calib_non_conformity_scores.shape[2:])
